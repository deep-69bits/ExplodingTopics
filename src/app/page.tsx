...
export default function Home() {
  ...
  return (
    <main className="min-h-screen z-50 w-full lg:max-w-7xl lg:py-8 py-5 lg:px-0 px-5   mx-auto">
      ...
      <h1 className="text-center font-semibold z-50 lg:text-[34px] text-[24px]  ">Discover Exploding Topics</h1>
      <h2 className="text-center lg:text-base z-50 text-[16px]  my-5 text-gray-500">We surface rapidly growing topics before they take off.</h2>
      ...
      <div className="lg:flex z-50 flex lg:flex-row flex-col  gap-y-2 justify-center gap-x-3 mt-10   items-center">
        ...
        <div className=" z-50 flex items-center justify-between lg:w-[170px] w-full  border-[1px] hover:border-black border-gray-200  cursor-pointer bg-white py-2 px-2">
          ...
          <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4 text-gray-400 text-[13px] ">
